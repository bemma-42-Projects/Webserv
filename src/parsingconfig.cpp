...
bool isSimpleDirective(std::string name) {
	if (name == "listen" || name == "root" || name == "client_max_body_size" || name == "server_name"
			...
			|| name == "allowed_methods" || name == "upload_path" || name == "allowed_upload" || name == "cgi_handler" || name == "alias")
		return (true);
	return (false);
}
...
bool directiveIsAllowed(std::string name, State state) {
	if (state == IN_SERVER && (name == "listen" || name == "root" || name == "client_max_body_size"
		...
		return (true);
			...
			|| name == "allowed_upload" || name == "client_max_body_size" || name == "error_page" || name == "cgi_handler" || name == "alias"))
		return (true);
	return (false);
}
